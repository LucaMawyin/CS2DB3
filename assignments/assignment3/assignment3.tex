...
\begin{titlepage}
    ...
    {\Huge COMPSCI 2DB3 Assignment 3}\\[2cm]
    
    {\large Luca Mawyin}\\[0.5cm]
    
    {\large Dr. Hellings}\\[0.5cm]
...
ORDER BY r.rid ASC, i.ingredient ASC;

-- Clarifications: Returns the rid of recipe that has ingredient not in product
